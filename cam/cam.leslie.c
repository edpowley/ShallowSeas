...
float	t;
{
	FILE	*out;
	int	i, j, k, sp;
	float	N[nspp][nstage];	/*weighted density for each species*/
	...
	switch(sp)
	{	case 0: /*species 0*/
			species[sp].leslie[0][0] =  0.999 - (1.0 - exp(-0.01*N[0][1]));
			species[sp].leslie[0][1] =  0.1;
			species[sp].leslie[0][2] =  0.0;
			species[sp].leslie[1][0] =  0.001;
			species[sp].leslie[1][1] =  0.999 - (1.0 - exp(-0.01*N[0][2]));
		...
		case 1:/*species 1*/
			species[sp].leslie[0][0] =   0.999 - (1.0 - exp(-0.01*N[1][1]));
			species[sp].leslie[0][1] =   0.0;
			species[sp].leslie[0][2] =   0.1;
			species[sp].leslie[1][0] =   0.001;
			species[sp].leslie[1][1] =   0.999 - (1.0 - exp(-0.01*N[1][2]));
			species[sp].leslie[1][2] =   0.0;
			species[sp].leslie[2][0] =   0.0;
    ...
    /***Output matrices***/
	if (flag_leslie==1 && x==0 && y==0) output_leslie(t, x, y);
...
float	t;
{
	...
	{	case 0: /*species 0*/
			...
			species[sp].leslie[0][2] =  0.0;
			species[sp].leslie[1][0] =  0.05 *        exp(-0.05*community.N[1][x][y]);
		...
		case 1:/*species 1*/
			...
			species[sp].leslie[1][2] =   0.0;
			species[sp].leslie[2][0] =   0.0;
			species[sp].leslie[2][1] =   0.2 *        exp(-0.05*community.N[2][x][y]);
